                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                        ...
                        <tbody>
                            ...
                            $dayIdMap = [
                                'senin' => 1,
                                // Add other days' IDs here if they have different IDs
                            ];
                            ...
                            ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td class="text-center">
                                        <a href="media.php?module=input_jadwal&act=edit_jadwal&idj=<?php echo htmlspecialchars($rs['idj']); ?>">
                                            <button type="button" class="btn btn-info">Edit</button>
                                        </a>
                                        <a href="module/simpan.php?act=hapus_jadwal&idj=<?php echo htmlspecialchars($rs['idj']); ?>">
