...
$idk = $connection->real_escape_string($klss);

// Prepare and execute query to get class information
                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered table-hover">
                        ...
                        <tbody>
                            <?php
                            $no = 1;
                            // Retrieve schedule information for Wednesday (idh=3) based on the class ID
                            $sql = "
                                ...
                                WHERE jadwal.idh = 3 AND jadwal.idk = '$idk'
