...
if (!empty($_SESSION['nama'])) {
    ...
    include "config/conn.php"; // Ensure this uses mysqli or PDO
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#">
                            ...
                            if ($level == "admin" || $level == "guru") {
                                $stmt = $connection->prepare("SELECT * FROM sekolah WHERE id = ?");
                                $stmt->bind_param("i", $idd);
                                $stmt->execute();
                                $result = $stmt->get_result();
                                $rsa = $result->fetch_assoc();
                                echo htmlspecialchars($rsa['nama']);
                            } else {
                                $stmt = $connection->prepare("SELECT * FROM kelas WHERE idk = ?");
                                $stmt->bind_param("i", $klss);
                                $stmt->execute();
                                $result = $stmt->get_result();
                                ...
                                echo "Kelas: " . htmlspecialchars($rs['nama']) . " | " . htmlspecialchars($rsa['nama']);
                            }
                            ?>
                        </a>
                    </li>
